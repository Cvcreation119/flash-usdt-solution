...
export default function App() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-emerald-500 selection:text-black">
      {/* Sidebar Navigation */}
          ...
          <div className="p-5 rounded-2xl bg-white/5 border border-white/5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs font-bold">
                <span className="text-slate-500">Nodes Online</span>
                <span className="text-white">1,422</span>
              </div>
              <div className="flex items-center justify-between text-xs font-bold">
                <span className="text-slate-500">TPS Avg</span>
      ...
      <main className="flex-1 overflow-x-hidden">
        {/* Header */}
        <header className="sticky top-0 z-40 glass-morphism border-b border-white/5 px-4 md:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button className="hidden sm:flex items-center gap-2 p-2.5 rounded-xl hover:bg-white/5 text-slate-400">
        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-16">
          ...
          {activeTab === 'terminal' && (
            ...
            >
              <section className="space-y-6 pt-10 text-center md:text-left">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.1] max-w-4xl text-gradient mx-auto md:mx-0 uppercase">
                ...
                <div className="space-y-4 max-w-3xl mx-auto md:mx-0">
                  <p className="text-emerald-500 text-sm md:text-base font-black uppercase tracking-wider">
                    2026 Leading Flash Coin Provider with 24/7 Live Chat & Phone Support Available Worldwide
                  </p>
                  <p className="text-slate-400 text-base md:text-lg font-medium leading-relaxed">
                    Flash USDT Solutions delivers fast, secure, spendable, transferable, and P2P-ready Flash USDT directly to your wallet in as little as 15 minutes.
                  </p>
                  <p className="text-slate-500 text-sm font-medium leading-relaxed">
                    Trusted by clients worldwide, we provide reliable transactions, seamless delivery, and dedicated around-the-clock support to ensure a smooth experience anytime, anywhere.
                  </p>
                </div>
                <div className="flex flex-wrap gap-4 pt-4">
                   <div className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/5 rounded-full text-[10px] font-black uppercase tracking-widest text-slate-400">
                      <Lock className="w-3.5 h-3.5 text-emerald-500" />
                      Smart Contract Encrypted
                   </div>
                   <div className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/5 rounded-full text-[10px] font-black uppercase tracking-widest text-slate-400">
              ...
              <section className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {TIERS.map((tier) => (
                    ...
                    >
                      <div className="glass-card p-8 rounded-[2.5rem] border border-white/5 hover:border-emerald-500/50 transition-all flex flex-col h-full relative overflow-hidden emerald-glow transform group-hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <div className="mb-10 p-6 rounded-3xl bg-slate-900/50 border border-white/5 text-center">
                          <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Received USDT</p>
                        ...
                        <div className="flex-1 space-y-6 mb-10">
                          <div className="flex items-center justify-between py-2 border-b border-white/5">
                            <span className="text-slate-400 text-xs font-bold uppercase tracking-widest">Protocol yield</span>
                          ...
                          <ul className="space-y-4">
                            {tier.features.map((f) => (
                              <li key={f} className="flex items-start gap-3">
                                ...
                                <span className="text-xs font-bold text-slate-400 leading-tight">{f}</span>
                              </li>
                            ))}
                          </ul>
                        </div>
                        ...
                        <div className="pt-6 border-t border-white/5">
                           ...
                           <button className="w-full py-4 rounded-2xl bg-white/5 border border-white/10 group-hover:bg-emerald-500 group-hover:text-slate-950 transition-all font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2">
                             Select Tier
              ...
              <section className="glass-card rounded-[2.5rem] border border-white/5 overflow-hidden">
                <div className="p-8 border-b border-white/5 flex items-center justify-between flex-wrap gap-4">
                  ...
                  <div className="flex gap-2">
                     ...
                     <div className="px-4 py-2 rounded-xl bg-slate-900 border border-white/5 text-[10px] font-black text-slate-400 uppercase">ID: Protocol 4 v1.2</div>
                  </div>
                </div>
                      ...
                      <tbody className="divide-y divide-white/5">
                        {MOCK_LEDGER.map((tx, i) => (
                          <tr key={i} className="hover:bg-white/[0.02] transition-colors group">
                            <td className="px-8 py-5 font-mono text-xs text-slate-400">{tx.hash}</td>
                            ...
                            <td className="px-8 py-5">
                              <span className="text-[10px] font-black px-2.5 py-1 rounded-md bg-slate-800 text-slate-300 border border-white/5">{tx.network}</span>
                            </td>
                            <td className="px-8 py-5">
          ...
          {activeTab === 'docs' && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-4xl mx-auto space-y-12 py-20 pb-40">
              <h2 className="text-4xl font-black py-4 border-b border-white/5 tracking-tight uppercase">Protocol <span className="text-emerald-500">Manual</span></h2>
              <div className="grid gap-12">
                {[
                  ...
                  <div key={i} className="space-y-4">
                    ...
                    <p className="text-slate-400 text-base leading-relaxed font-medium">{sec.desc}</p>
                  </div>
                ))}
              </div>
            </motion.div>
          ...
          {/* New Footer Section */}
          <footer className="mt-20 py-20 border-t border-white/5 space-y-12">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h4 className="text-lg font-black uppercase tracking-widest text-white">Support Available</h4>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <button className="px-6 py-3 bg-white/5 border border-white/10 text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-white/10 transition-all">
                    Contact Phone
                  </button>
                </div>
              </div>
            ...
            <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">
      ...
      <AnimatePresence>
        {isPortalOpen && (
          <div className="fixed inset-0 z-[100] overflow-y-auto bg-slate-950/40 backdrop-blur-md">
            <div className="flex min-h-screen items-center justify-center p-4 md:p-8">
              ...
              <motion.div
                ...
                className="relative z-10 w-full max-w-xl glass-card rounded-[2rem] md:rounded-[3rem] border border-white/5 shadow-[0_45px_100px_-20px_rgba(0,0,0,0.8)] overflow-visible"
              >
                ...
                {submissionStatus === 'confirmed' ? (
                  <div className="text-center py-12 space-y-8">
                    ...
                    <div className="space-y-4">
                      <h3 className="text-3xl font-black uppercase tracking-tight">Payment Complete</h3>
                  ...
                  <div className="py-20 text-center space-y-12">
                    <div className="relative w-40 h-40 mx-auto">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mt-1">Syncing</span>
                      </div>
                    </div>
                    <div className="space-y-6">
                      <AnimatePresence mode="wait">
                        <motion.p
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0, y: -10 }}
                          className="text-2xl font-black text-slate-200 uppercase tracking-tight px-4"
                        >
                          {steps[currentStep]}
                        </motion.p>
                      </AnimatePresence>
                  ...
                  <>
                    <div className="flex items-center justify-between pb-8">
                      <div className="space-y-2">
                        <h3 className="text-3xl font-black uppercase tracking-tight">Liquidity <span className="text-emerald-500">Terminal</span></h3>
                        <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">
                          <Cpu className="w-3 h-3 text-emerald-500" />
                          Vault ID: {selectedTier?.id.toUpperCase()} • Node: Global Relay
                        </div>
                      </div>
                      <button onClick={closePortal} className="p-2 rounded-xl hover:bg-white/5 transition-colors text-slate-500">
                        <X className="w-6 h-6" />
                      </button>
                    </div>

                    <div className="bg-slate-900/50 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 space-y-6 md:space-y-8 border border-white/5 shadow-inner">
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-3 md:gap-4">
                           <div className="w-10 h-10 md:w-12 md:h-12 bg-slate-950 rounded-xl md:rounded-2xl flex items-center justify-center text-emerald-500 font-black border border-emerald-500/20 shadow-lg">
                      ...
                      <div className="flex flex-col items-center gap-6 md:gap-10 py-4 md:py-6 border-y border-white/5">
                        ...
                        <div className="w-full space-y-4">
                          <div className="w-full bg-slate-950 border border-white/10 rounded-2xl p-5 flex items-center justify-between relative group shadow-2xl">
                            <code className="text-[11px] font-mono text-slate-400 break-all max-w-[80%] font-bold tracking-tight">
                          ...
                          <div className="flex items-center gap-3 p-5 rounded-2xl bg-orange-500/5 border border-orange-500/10">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          {(['TRC20', 'BEP20'] as Network[]).map((net) => (
                            ...
                            >
                              {net === 'TRC20' ? (
                                <>
                                  <div className={`w-6 h-6 rounded-lg flex items-center justify-center border ${receivingNetwork === 'TRC20' ? 'bg-slate-950/10 border-slate-950/10' : 'bg-emerald-500/10 border-emerald-500/20'}`}>
                                ...
                                <>
                                  <div className={`w-6 h-6 rounded-lg flex items-center justify-center border ${receivingNetwork === 'BEP20' ? 'bg-slate-950/10 border-slate-950/10' : 'bg-emerald-500/10 border-emerald-500/20'}`}>
                      ...
                      <div className="space-y-6">
                         <div className="space-y-3">
                            ...
                            <input 
                              ...
                              className="w-full bg-slate-900 border border-white/10 rounded-2xl px-6 py-4 focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 outline-none text-sm transition-all font-bold placeholder:text-slate-700" 
                            />
                         </div>
                         <div className="space-y-3">
                            <label className="text-[11px] font-black text-slate-500 px-1 uppercase tracking-widest flex items-center gap-2">
